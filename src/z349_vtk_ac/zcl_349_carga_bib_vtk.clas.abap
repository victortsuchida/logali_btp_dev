CLASS zcl_349_carga_bib_vtk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_349_carga_bib_vtk IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
"NEW CHANGE

    data: lt_acc_categ type table of ztb_acc_categ_vt,
          lt_catego    type table of ztb_catego_vtk,
          lt_clientes  type table of ztb_clientes_vtk,
          lt_clnts_lib type table of ztb_clnts_lib_vt,
          lt_libros    type table of ztb_libros_vtk.
...
******** TABLA1 ********
    ...
    delete from ztb_acc_categ_vt.
    insert ztb_acc_categ_vt from table @lt_acc_categ.
...
******** z349_catego ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_vtk.
    insert ztb_catego_vtk from table @lt_catego.
...
******** z349_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_vtk.
    insert ztb_clientes_vtk from table @lt_clientes.
...
******** z349_clnts_lib
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_vt.
    insert ztb_clnts_lib_vt from table @lt_clnts_lib.
...
******** z349_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_vtk.
    insert ztb_libros_vtk from table @lt_libros.
